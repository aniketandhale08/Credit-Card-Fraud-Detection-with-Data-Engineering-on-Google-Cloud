      ...
      def process(self, context):
        ...
        while True:
            ...
            for received_message in response.received_messages:
                ...
                # Endpoint details
                project = "859567120203"
                endpoint_id = "8703356912986488832"
                ...
                if predicted_isFraud == "1":
                    ...
                    table_id = "final-year-project-438314.transaction.fraud_data_layer"
                    ...
                    features_passed_to_check = json.loads(MessageToJson(instances[0]))
                    table_id = "final-year-project-438314.transaction.non_fraud_data_layer"
